...
public class ZvejysPage {
    ...
    public static void enterReelNametoSearchBox(String reelName) {
        Common.sendKeysToElement(Locators.Zvejys.search.inputReelName, reelName);
    }

    public static void clickOnPaieskaButton() {
        Common.clickOnElement(Locators.Zvejys.search.clickOnPaieskaButton);
    }

    public static String getItemName() {
        return Common.getTextFromElement(
                Locators.Zvejys.search.getSearchItemName
        );
    }
}
